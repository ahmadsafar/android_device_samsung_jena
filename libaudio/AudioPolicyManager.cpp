...
{
    uint32_t device = 0;
LOGE("(1)mAvailableOutputDevices=%x", mAvailableOutputDevices);
	...
	// For MT ringtone, HS+SPK
	 // if (mPhoneState == AudioSystem::MODE_RINGTONE) {
            // LOGE(" ***************************** HS+SPK ***************************** ");
              // device = AudioSystem::DEVICE_OUT_WIRED_HEADSET | AudioSystem::DEVICE_OUT_SPEAKER;
            // break;
        // }
        device = mAvailableOutputDevices & AudioSystem::DEVICE_OUT_SPEAKER;
        if (device == 0) {
    ...
    case STRATEGY_MEDIA: {
        LOGE("mAvailableOutputDevices=%x", mAvailableOutputDevices);
        ...
        if (device2 == 0 && (mAvailableOutputDevices&AudioSystem::DEVICE_OUT_FM)) {
            LOGE("fm_headset");
            device2 = mAvailableOutputDevices & AudioSystem::DEVICE_OUT_FM;
        }
        if (device2 == 0 && (mAvailableOutputDevices&AudioSystem::DEVICE_OUT_FM_SPEAKER)) {
            LOGE("fm_speaker");
